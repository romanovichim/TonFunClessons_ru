import {
  require_react_dom
} from "./chunk-WOSALZBR.js";
import {
  require_react
} from "./chunk-MDEJEYXF.js";
import {
  __toESM,
  import_process,
  init_shim
...
function readProcessEnvBooleanFlag(name, set) {
  ...
  const sanitizedValue = (_process$env$name = import_process.default.env[name]) === null || _process$env$name === void 0 ? void 0 : (_process$env$name$toL = _process$env$name.toLowerCase()) === null || _process$env$name$toL === void 0 ? void 0 : _process$env$name$toL.trim();
...
function readProcessEnvStringArrayFlag(name, set) {
  ...
  const sanitizedValue = (_process$env$name2 = import_process.default.env[name]) === null || _process$env$name2 === void 0 ? void 0 : _process$env$name2.trim();
  if (sanitizedValue == null || sanitizedValue === "") {
    return;
  }
...
function applyProcessEnvFlagOverrides() {
  ...
  if (((_process = import_process.default) === null || _process === void 0 ? void 0 : _process.env) == null) {
    return;
  }
...
function recoilCallback(store, fn, args, extraInterface) {
  ...
  !!(ret instanceof Sentinel) ? import_process.default.env.NODE_ENV !== "production" ? Recoil_invariant(false, "batchUpdates should return immediately") : Recoil_invariant(false) : void 0;
  ...
  function evaluateSelectorGetter(store, state, executionID) {
    ...
    const getCallback = (fn) => {
      return (...args) => {
        ...
        !(recoilValue != null) ? import_process.default.env.NODE_ENV !== "production" ? Recoil_invariant(false, "Recoil Value can never be null") : Recoil_invariant(false) : void 0;
  ...
  function getLoadableFromCacheAndUpdateDeps(store, state) {
    ...
    try {
      cachedLoadable = cache.get((nodeKey) => {
        !(typeof nodeKey === "string") ? import_process.default.env.NODE_ENV !== "production" ? Recoil_invariant(false, "Cache nodeKey is type string") : Recoil_invariant(false) : void 0;
