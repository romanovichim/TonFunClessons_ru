...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react"), require("@tonconnect/ui")) : typeof define === "function" && define.amd ? define(["exports", "react", "@tonconnect/ui"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["@tonconnect/ui-react"] = {}, global.React, global.TON_CONNECT_UI));
})(this, function(exports2, require$$0, ui) {
  "use strict";
  ...
  function useTonAddress(userFriendly = true) {
    ...
    if (wallet) {
      return userFriendly ? ui.toUserFriendlyAddress(wallet.account.address, wallet.account.chain === ui.CHAIN.TESTNET) : wallet.account.address;
    } else {
      return "";
    }
  }
  ...
  exports2.TonConnectButton = TonConnectButton$1;
  exports2.TonConnectProviderNotSetError = TonConnectProviderNotSetError;
  exports2.TonConnectUIContext = TonConnectUIContext;
  exports2.TonConnectUIProvider = TonConnectUIProvider$1;
  exports2.TonConnectUIReactError = TonConnectUIReactError;
  exports2.useIsConnectionRestored = useIsConnectionRestored;
  exports2.useTonAddress = useTonAddress;
  exports2.useTonConnectUI = useTonConnectUI;
  exports2.useTonWallet = useTonWallet;
  for (const k in ui) {
