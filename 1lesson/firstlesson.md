...
## Компиляция контракта в .fif

После того, как мы написали контракт на языке FUNC, его нужно скомпилировать в FIFT.

`toncli build`

Скомпилированные файлы появятся в папке ./build.
