...
В данном репозитории представлены уроки по FunC для блокчейна TON. Уроки расположены в соответствующих папках в формате .md, также к каждому уроку приложен код. Наше комьюнити - [здесь](https://t.me/ton_learn).
...
| 14 | Разбираем TON DNS смарт-контракт | | | ❌  |
| 15 | Статья о TON DNS | | | ❌  |
| 16 | Разбираем DAO контракт | | | ❌  |
| 17 | Статья про Governance | | | ❌  |
| 18 | Buy me a coffee | | | ❌  |
| 19 | Секретный контент для [канал](https://t.me/ton_learn) в размере 10 штук)  | | | ❌  |
| 20 | Мероприятия для привлечения разработчиков в экосистему TON | | | ❌  |
