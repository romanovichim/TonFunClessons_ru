...
Content по стандарту можно посмотреть [здесь](https://github.com/ton-blockchain/TEPs/blob/master/text/0064-token-data-standard.md). Так как это тестовый пример собирать все данные не будем, положим только ссылку и то на уроки))
